...
class DetalhesOrcamento extends StatelessWidget {
  ...
  const DetalhesOrcamento({Key? key, required this.orcamento})
      : super(key: key);
                ...
                children: [
                  Card(
                    child: ListTile(
                      ...
                      title:
                          Text('Nome do Cliente: ${orcamento['nome_cliente']}'),
                  ...
                  Card(
                    child: ListTile(
                      leading:
                          const Icon(Icons.payment, color: Color(0xFF043259)),
                      title: Text(
                  ...
                  Card(
                    child: ListTile(
                      leading:
                          const Icon(Icons.money_off, color: Color(0xFF043259)),
                      title: Text(
