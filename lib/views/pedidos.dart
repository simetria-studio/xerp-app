...
import 'package:xerpapp/views/detalhes_pedido.dart';
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              DetalhesPedido(orcamento: orcamento),
                        ));
                      },
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                orcamento['situacao_pedido'] == "O"
                                    ? "Orçamento"
                                    : orcamento['situacao_pedido'] == "FP"
                                        ? "Faturado Parcial"
                                        : orcamento['situacao_pedido'] == "G"
                                            ? "Gerado OP"
                                            : orcamento['situacao_pedido'] ==
                                                    "A"
                                                ? "Aberto"
                                                : orcamento['situacao_pedido'] ==
                                                        "F"
                                                    ...
                                                    : orcamento['situacao_pedido'] ==
                                                            "C"
                                                        ? "Cancelado"
                                                        : "Desconhecido", // Tratamento para outros valores
                                style: const TextStyle(
                                  color: Color(0xFF404040),
                                  fontSize: 12,
                                  fontFamily: 'Arial',
